...
void main() {
  final BarkAuthenticationPlatform initialPlatform =
      BarkAuthenticationPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockBarkAuthenticationPlatform fakePlatform =
        MockBarkAuthenticationPlatform();
